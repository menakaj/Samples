...
package org.wso2.iot.sample.alexaconnector.alexaConnector.plugin.constants;
...
public class DeviceTypeConstants {
    public final static String DEVICE_TYPE = "alexa";
    public final static String DEVICE_PLUGIN_DEVICE_NAME = "DEVICE_NAME";
    public final static String DEVICE_PLUGIN_DEVICE_ID = "alexa_DEVICE_ID";
    ...
    public static final String DATA_SOURCE_NAME = "jdbc/alexaDM_DB";
    ...
    public static final String SUBSCRIBED_TOPIC = "carbon.super/alexa/+/alexa";
