...
package org.wso2.iot.sample.alexaconnector.alexaConnector.api;

import org.wso2.iot.sample.alexaconnector.alexaConnector.api.dto.DeviceJSON;
import org.wso2.iot.sample.alexaconnector.alexaConnector.api.dto.SensorRecord;
import org.wso2.iot.sample.alexaconnector.alexaConnector.api.util.APIUtil;
import org.wso2.iot.sample.alexaconnector.alexaConnector.api.util.ZipUtil;
import org.wso2.iot.sample.alexaconnector.alexaConnector.api.util.ZipArchive;
...
public class DeviceTypeServiceImpl implements DeviceTypeService {
    ...
    public Response changeStatus(@PathParam("deviceId") String deviceId,
        ...
        try {
            ...
            deviceIdentifiers.add(new DeviceIdentifier(deviceId, "alexa"));
            APIUtil.getDeviceManagementService().addOperation("alexa", commandOp,
                                                              deviceIdentifiers);
