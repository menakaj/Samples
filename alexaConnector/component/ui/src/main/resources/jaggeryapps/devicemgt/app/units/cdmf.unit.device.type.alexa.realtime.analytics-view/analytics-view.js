...
function onRequest(context) {
	...
	var websocketEndpointForStream1 = websocketEndpoint + "/secured-websocket/org.wso2.iot.devices.alexa/1.0.0?deviceId=" + device.deviceIdentifier + "&deviceType=" + device.type;
	var websocketEndpointForStream2 = websocketEndpoint + "/secured-websocket/org.wso2.iot.devices.alexa1/1.0.0?deviceId=" + device.deviceIdentifier + "&deviceType=" + device.type;
	return {
		"device": device,
